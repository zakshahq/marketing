...
(function () {
  ...
  var I = {
    ...
    sparkle: '<path d="M10 4C10.4 8.5 11.5 10 16 10.5 11.5 11 10.4 12.5 10 17 9.6 12.5 8.5 11 4 10.5 8.5 10 9.6 8.5 10 4z"/><path d="M18 14.5c.2 2 .7 2.5 2.5 2.7-1.8.2-2.3.7-2.5 2.8-.2-2.1-.7-2.6-2.5-2.8 1.8-.2 2.3-.7 2.5-2.7z"/>',
    ...
    robot: '<rect x="4" y="9" width="16" height="10" rx="3"/><path d="M12 5v4"/><circle cx="12" cy="4" r="1.2"/><path d="M9 13.5h.01M15 13.5h.01M9.5 16.5h5"/>',
